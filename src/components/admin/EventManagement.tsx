...
const EventManagement = ({ events, onEventsUpdate }: EventManagementProps) => {
  ...
  const [formData, setFormData] = useState({
    ...
    min_team_size: 1,
    max_team_size: 1,
    max_team_capacity: null as number | null,
  })
  ...
  const openEditForm = (event: Event) => {
    setFormData({
      ...
      max_team_capacity: (event as any).max_team_capacity || null,
    })
      ...
      <Dialog open={showForm} onOpenChange={resetForm}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Provide the event details and team size requirements.</DialogDescription>
          </DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({ ...formData, min_team_size: Number.parseInt(e.target.value) })}
                  required
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({ ...formData, max_team_size: Number.parseInt(e.target.value) })}
                  required
                />
              </div>
            </div>
            ...
            <div>
              <Label htmlFor="max_team_capacity">Max Team Capacity (Optional)</Label>
              <Input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    max_team_capacity: e.target.value ? Number.parseInt(e.target.value) : null,
                  })
                }
                placeholder="Leave empty for unlimited capacity"
              />
              <p className="text-sm text-muted-foreground mt-1">
                Maximum number of teams that can register for this event. Leave empty for unlimited capacity.
              </p>
            </div>
            ...
            <div className="flex space-x-3">
              ...
              <Button type="submit" disabled={loading} className="flex-1 bg-gradient-primary hover:opacity-90">
