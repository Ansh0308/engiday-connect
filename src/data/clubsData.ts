...
export const clubsData: Club[] = [
  {
    ...
    contacts: [
      {
        name: "Kaushal Parmar",
        role: "Convener",
        email: "kaushal.parmar120809@marwadiuniversity.ac.in",
        phone: "+91 99779009525",
      },
      {
        name: "Payal Makwana",
        role: "Dy. Convener",
    ...
    socialMedia: {
      instagram: "https://www.instagram.com/cpclub_mu/",
    },
  },
  {
    id: "circuitology",
    ...
    committeePosterUrl: "/images/committees/circuitology-committee.jpeg",
    events: [
      {
        id: "circuit-design-1",
    ...
    contacts: [
      ...
      },
      {
        ...
        phone: "+91 6353 334 811",
      },
      {
        name: "Prof. Vijay Dubey",
        role: "Faculty",
        email: "vijay.dubey@marwadieducation.edu.in",
        phone: "+91 97232 652785",
      },
    ],
    socialMedia: {
      instagram: "https://www.instagram.com/circuitology.club/",
    },
  },
  {
    id: "data-science",
    ...
    committeePosterUrl: "/images/committees/ds-committee.png",
    events: [
      {
        id: "ml-hackathon-1",
    ...
    contacts: [
      {
        name: "Rudra Miyani",
        role: "Convener",
        email: "rudra.miyani130158@marwadiuniversity.ac.in",
        phone: "+91 832 077 5320",
      },
      {
        name: "Dhyana Kothari",
        role: "Dy. Convener",
        email: "dhyanakothari.121782@marwadiuniversity.ac.in",
        phone: "+91 93776 87833",
      },
      {
        name: "Prof. Nishith Kotak",
        role: "Faculty",
    ...
    socialMedia: {
      instagram: "https://www.instagram.com/datascienceclub_mu/",
    },
  },
  {
    id: "cloud-devops",
    ...
    committeePosterUrl: "/images/committees/ccdc-committee.jpeg",
    events: [
      {
        id: "cloud-deploy-1",
    ...
    contacts: [
      {
        name: "Rohan Roy",
        role: "Convener",
        email: "rohanroy.121022@marwadiuniversity.ac.in",
        phone: "+91 96240 03972",
      },
      {
        name: "Jahnvi Aghera",
        role: "Dy. Convener",
        email: "jahnvi.aghera124513@marwadiuniversity.ac.in",
        phone: "+91 87994 48954",
      },
      {
        name: "Dr. Arjav Bavarva",
        role: "Faculty",
        email: "arjav.bavarva@marwadieducation.edu.in",
        phone: "+91 70166 85360",
      },
    ],
  },
]
